...
from create_case_maps import plot_test_map
from helper import Mode

WIDTH = 210
HEIGHT = 297

TEST_DATE = "10/20/20" # here we need to capture the time period selected by the user
...
def create_title(day, pdf):
  ...
  pdf.write(4, f'Time period selected: {day}')
  pdf.ln(5)
...
def create_analytics_report(day=TEST_DATE, filename="report.pdf"):
  ...
  ''' First Page '''
  pdf.add_page()
  pdf.image("./resources/Picture1.png", 0, 0, WIDTH)
  create_title(day, pdf)

  plot_test_map("./tmp/lisbon_fraguesias.png")
  pdf.ln(10)
  pdf.set_font('Arial', '', 16)
  pdf.write(4, f'Temperature map:')

  pdf.image("./tmp/lisbon_fraguesias.png", 5, 90, WIDTH-20)
